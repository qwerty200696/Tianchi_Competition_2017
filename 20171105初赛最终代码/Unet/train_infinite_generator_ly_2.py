...
def batch_generator(batch_size):
    input_path = 'E:/Tianchi/train_data/train_data_red_224/orig_red/'
    label_path = 'E:/Tianchi/train_data/train_data_red_224/label_exp/'
...
def batch_generator_tes(batch_size):
...
def train_unet():
    output_model_path = 'zf_unet_224_temp_vv5_best.h5'
    epochs = 150
    patience = 1000
    batch_size = 16
    optim_type = 'Adam'
