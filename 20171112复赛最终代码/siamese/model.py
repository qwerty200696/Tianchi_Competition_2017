...
def dense_net(image, is_training=True):
    ...
    with tf.variable_scope('conv2_3') as scope:
        ...
        l = bn_relu_conv(l_big, is_training, 32, 32, 3, 2, name='bn_relu_conv2')
        l_big2 = bn_relu_conv(l, is_training, 32, 32, 3, 1, name='bn_relu_conv3')

    l_first_down = tf.nn.max_pool(l_big2, [1, 2, 2, 1], strides=[1, 2, 2, 1], padding='SAME')
