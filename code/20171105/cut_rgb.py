...
for i in range(int(len(im_2015) / img_size) + 1):  # last 284
    for j in range(int(len(im_2015[0]) / img_size) + 1):  # last 2 too small, drop one
        ...
        r2015 = scale_percentile(
            im_2015[i * img_size:i * img_size + img_size, j * img_size:j * img_size + img_size, 0:1]) * 255
        g2015 = scale_percentile(
            im_2015[i * img_size:i * img_size + img_size, j * img_size:j * img_size + img_size, 1:2]) * 255
        b2015 = scale_percentile(
            im_2015[i * img_size:i * img_size + img_size, j * img_size:j * img_size + img_size, 2:3]) * 255
        r2017 = scale_percentile(
            im_2017[i * img_size:i * img_size + img_size, j * img_size:j * img_size + img_size, 0:1]) * 255
        g2017 = scale_percentile(
            im_2017[i * img_size:i * img_size + img_size, j * img_size:j * img_size + img_size, 1:2]) * 255
        b2017 = scale_percentile(
            im_2017[i * img_size:i * img_size + img_size, j * img_size:j * img_size + img_size, 2:3]) * 255
